...
@php
    ...
    $titulo        = "Canchas";
    $table         = "zona";
    $entidadSing   = "Cancha"; // singular bonito para mostrar en frases
    $entidadPlural = "Canchas"; // plural para el título y más
    $apiUrl        = "/api/zona"; 
    $urlEliminar   = "/zona/";
    $urlModificar  = "/zona/";
    $columnas = [
        ...
        ['key' => 'tipo_deporte.descripcion',   'label' => 'Tipo de Deporte'],
        ['key' => 'deporte.descripcion',        'label' => 'Deporte'],
        ['key' => 'superficie.descripcion',     'label' => 'Superficie'],
        ['key' => 'estado_zona.descripcion',    'label' => 'Estado de la Zona'],
        ['key' => 'sucursal.descripcion',       'label' => 'Sucursal'],
