...
@php
    ...
    $entidadSing   = "Tipo de Documento"; // singular bonito para mostrar en frases
    $entidadPlural = "Tipos de Documentos"; // plural para el título y más
    $apiUrl        = "/api/tipo-documento"; 
    $urlEliminar   = "/tablas-maestras/tipo-documento/";
    $urlModificar  = "/tablas-maestras/tipo-documento/";
