...
@php
    ...
    $titulo        = "Localidades";
    $table         = "localidad";
    $entidadSing   = "Localidad"; // singular bonito para mostrar en frases
    $entidadPlural = "Localidades"; // plural para el título y más
    $apiUrl        = "/api/localidad"; 
    $urlEliminar   = "/tablas-maestras/localidad/";
    $urlModificar  = "/tablas-maestras/localidad/";
    $columnas = [
        ['key' => 'id',             'label' => 'ID'],
        ['key' => 'descripcion',         'label' => 'Descripcion'],
        ['key' => 'provincia.descripcion',      'label' => 'Provincia'],
