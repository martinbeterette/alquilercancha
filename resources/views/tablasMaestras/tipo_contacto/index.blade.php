...
@php
    ...
    $table         = "tipo_contacto";
    $entidadSing   = "Tipo de Contacto"; // singular bonito para mostrar en frases
    $entidadPlural = "Tipos de Contactos"; // plural para el título y más
    $apiUrl        = "/api/tipo-contacto"; 
    $urlEliminar   = "/tablas-maestras/tipo-contacto/";
    $urlModificar  = "/tablas-maestras/tipo-contacto/";
