...
@php
    ...
    $table         = "tipo_deporte";
    $entidadSing   = "Tipo de Deporte"; // singular bonito para mostrar en frases
    $entidadPlural = "Tipos de Deportes"; // plural para el título y más
    $apiUrl        = "/api/tipo-deporte"; 
    $urlEliminar   = "/tablas-maestras/tipo-deporte/";
    $urlModificar  = "/tablas-maestras/tipo-deporte/";
    $columnas = [
        ['key' => 'id',                    'label' => 'ID'],
