...
@php
    ...
    $table         = "tipo_zona";
    $entidadSing   = "Tipo de Zona"; // singular bonito para mostrar en frases
    $entidadPlural = "Tipos de Zonas"; // plural para el título y más
    $apiUrl        = "/api/tipo-zona"; 
    $urlEliminar   = "/tablas-maestras/tipo-zona/";
    $urlModificar  = "/tablas-maestras/tipo-zona/";
