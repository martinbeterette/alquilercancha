...
@php
    ...
    $titulo        = "Provincias";
    $table         = "provincia";
    $entidadSing   = "Provincia"; // singular bonito para mostrar en frases
    $entidadPlural = "Provincias"; // plural para el título y más
    $urlBase       = "/tablas-maestras/provincia/";
    $apiUrl        = "/api/provincia"; 
    $urlEliminar   = $urlBase;
    $urlModificar  = $urlBase;
    $columnas = [
        ['key' => 'id',           'label' => 'ID'],
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ¿Estás seguro de que querés eliminar esta {{ $entidadSing }}? Esta acción no se puede deshacer.
                </div>
