<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Crear Role') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Formulario Crear Role') }}</flux:subheading>
    ...
    <div>
        ...
        <div class="w-150">
            <form wire:submit="submit" class="mt-6 space-y-6">
                <flux:input wire:model="role" label="Perfil" placeholder="Perfil"/>
